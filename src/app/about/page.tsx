...
const AboutPage = () => {
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-col gap-16 p-8">
      ...
      {/* Keep avatar outside stagger so ViewTransition doesn't morph into opacity:0 */}
      <header className="flex flex-col gap-5">
        <ViewTransition name="profile-avatar" default="none" share="morph">
          <div className="relative mb-1 size-14 overflow-hidden rounded-[50%] [corner-shape:squircle]">
