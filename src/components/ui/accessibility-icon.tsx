...
import type { AnimatedIconHandle, AnimatedIconProps, IconEasing } from './types';
...
const AccessibilityIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps & CustomAnimation>(
  (
    {
      size = 24,
      color = 'currentColor',
    ...
    const start = async () => {
      ...
      animate('.person', { y: [0, -2, 0] }, { duration: personDuration, ease: personEase });
    };
